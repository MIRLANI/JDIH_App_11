...
class DashboardController extends Controller
{
    public function index(): Response
    {
        ...
        return response()->view('pages.admin.index', compact('jmlPeraturan', 'jmlKatagori', 'jmlTipe', 'jmlTag', 'jmlPeraturanAktif', 'jmlPeraturanTidakAktif', 'jmlPeraturanPerLimaTahun', 'jmlReview', 'jmlDownload'));
    }
}
