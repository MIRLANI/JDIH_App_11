    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="updateAbstractModalLabel-{{ $Password->id }}">Update Password Dokument</h5>
            ...
            <div class="modal-body">
                <form class="form" method="POST" action="{{ route('update.password', ['id' => $Password->id]) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="password_name" id="password_name"
                            value="{{ $Password->password_name ?? '-' }}" placeholder="Masukkan Password Name">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted mt-2">Contoh: 123456</small>
                    </div>
