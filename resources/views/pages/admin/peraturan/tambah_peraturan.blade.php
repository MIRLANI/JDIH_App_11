                                ...
                                <form class="form" action="{{ route('store.peraturan') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        @if (Auth::user()->role == 'admin')
                                            <div class="col-md-6 col-12 mt-3">
                                                <div class="form-group mandatory">
                                                    <label for="sumber_dokumen" class="form-label">Sumber Peraturan </label>
                                                    <select id="sumber"
                                                        ...
                                                        @foreach ($sumbers as $sumber)
                                                            <option value="{{ $sumber->id }}"
                                                                {{ old('user_id') == $sumber->id ? 'selected' : '' }}>
                                        ...
                                        @else
                                            @if ($sumbers)
                                                <input type="hidden" name="user_id" value="{{ $sumbers->id }}">
                                            @endif
                                        @endif
                                        ...
                                        {{-- status peraturan --}}
                                        {{-- @include('pages.admin.peraturan.status.tambah') --}}
                                        <div class="mt-5">
                                            <h4 class="card-title"><b>File Peraturan</b></h4>
                                        </div>
                                        <div class=" col-12 mt-3 mt-4">
                                            <div class="form-group ">
                                                ...
                                                @enderror
                                                <p class="small mt-2"><i>Masukan file peraturan format pdf</i>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="mt-5"></div>
