            ...
            <div class="row" >
                <div class="col-12">
                    <div  class="col-lg-12 d-flex flex-column justify-content-center align-items-center pt-4 pt-lg-0 order-2 order-lg-1"
                        ...
                        <h1 class="text-center">Better Solutions For Your Business</h1>
                        <h2 class="text-center">We are team of talented designers making websites with Bootstrap</h2>
                        <div class="d-flex justify-content-center justify-content-lg-start">
                            <a href="#about" class="btn-get-started scrollto">Get Started</a>
                            <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="glightbox btn-watch-video ml-2"><i
                                    class="bi bi-play-circle"></i><span>Watch Video</span></a>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{ asset("users/assets/img/gambar-hukum.png") }}" class="img-fluid animated" alt="">
                </div> --}}
            </div>
        </div>
    </section>
            ...
            <div class="container">
                ...
                <div class="row" data-aos="zoom-in">
                    ...
                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="{{ asset("users/assets/img/clients/client-1.png") }}" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="{{ asset("users/assets/img/clients/client-2.png") }}" class="img-fluid" alt="">
                    </div>
            ...
            <div class="container-fluid" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img"
                        style='background-image: url("{{ asset("users/assets/img/why-us.png") }}");' data-aos="zoom-in" data-aos-delay="150">
                        &nbsp;</div>
                </div>
