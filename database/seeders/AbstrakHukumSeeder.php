...
class AbstrakHukumSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ];
        // $abstrak = Abstrak::query()->create($data1);
        // $abstrak->save();
        ...
        // ];
        // $abstrak = Abstrak::query()->create($data2);
        // $abstrak->save();
        ...
        // ];
        // $abstrak = Abstrak::query()->create($data3);
        // $abstrak->save();
        ...
        // ];
        // $abstrak = Abstrak::query()->create($data4);
        // $abstrak->save();
        ...
        // ];
        // $abstrak = Abstrak::query()->create($data5);
        // $abstrak->save();
    }
}
